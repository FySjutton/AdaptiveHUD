...
//    }
//
//    public String velocity_xyz(@SpecialFlagName("R") String round) {
...
//    }
//
//    public String tfx(@SpecialFlagName("R") String round) {
//        BlockHitResult targetBlock = (BlockHitResult) complexVARS.targetBlockFluid;
//        return targetBlock == null ? null : tools.roundNum((float) targetBlock.getPos().x, round == null ? 0 : Integer.parseInt(round));
//    }
//
//    public String tfy(@SpecialFlagName("R") String round) {
//        BlockHitResult targetBlock = (BlockHitResult) complexVARS.targetBlockFluid;
//        return targetBlock == null ? null : tools.roundNum((float) targetBlock.getPos().y, round == null ? 0 : Integer.parseInt(round));
//    }
//
//    public String tfz(@SpecialFlagName("R") String round) {
//        BlockHitResult targetBlock = (BlockHitResult) complexVARS.targetBlockFluid;
//        return targetBlock == null ? null : tools.roundNum((float) targetBlock.getPos().z, round == null ? 0 : Integer.parseInt(round));
//    }
//
//    public String tf_distance(@SpecialFlagName("R") String round) {
//        BlockHitResult targetBlock = (BlockHitResult) complexVARS.targetBlockFluid;
//        return targetBlock == null ? null : tools.roundNum((float) Math.sqrt(targetBlock.squaredDistanceTo(player)), round == null ? 1 : Integer.parseInt(round));
//    }
//
...
//    }
//
//    public String tex(@SpecialFlagName("R") String round) {
...
//    }
//
//    public String tey(@SpecialFlagName("R") String round) {
...
//    }
//
//    public String tez(@SpecialFlagName("R") String round) {
...
//    }
//
//    public String te_distance(@SpecialFlagName("R") String round) {
...
//    }
//
//    public String mtps(@SpecialFlagName("R") String round) {
//        IntegratedServer server = client.getServer();
//        if (server != null) {
...
//    }
//
//    public String gpu(@SpecialFlagName("R") String round) {
...
//    }
//    public String yaw(@SpecialFlagName("R") String round) {
//        float yawN = MathHelper.wrapDegrees(player.getYaw());
//        if (round == null) {round = "0";}
//        return tools.roundNum(yawN, Integer.parseInt(round));
//    }
//    public String pitch(@SpecialFlagName("R") String round) {
